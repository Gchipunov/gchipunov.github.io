...
var div1img2 = document.createElement('img');
 div1img2.src= GBL.Media2 +'Rock2.png';
div1img2.id = "Rock2";
...
div1img2.style.left = GBL.Rock2posX + 'px';
div1img2.style.top = GBL.Rock2posY + 'px';
div1img2.style.position = 'absolute';
...
var div1img3 = document.createElement('img');
 div1img3.src= GBL.Media2 +'Rock1_t2.png';
div1img3.id = "Rock1";

 GBL.Rock1posX = '200';
 GBL.Rock1posY = '25';

div1img3.style.position = 'absolute';
div1img3.style.left = GBL.Rock1posX + 'px';
div1img3.style.top = GBL.Rock1posY + 'px';
...
img1.style.left = GBL.character.x + "px";
img1.style.top = GBL.character.y + "px";
...
setInterval(MoveCharacterUpdate,16.666,100);
//setInterval(MoveCharacterUpdate,15,100);
//setInterval(MoveCharacterUpdate,100,100);
...
//MoveCharacterForward();
//console.log('MoveCharacterForward()');
if(GBL.character.y > GBL.character.groundy - 20)
{

GBL.character.y = GBL.character.y-20;
}
...
GBL.platformsData = [
  { x: 0, y: 0, w: 6000, h: 40, spriteId: 15, color: "rgba(102,128,102,1)" },
  { x: 50, y: 150, w: 200, h: 30, spriteId: 16, color: "rgba(102,128,102,1)" },
  { x: 50, y: 300, w: 200, h: 30, spriteId: 17, color: "rgba(102,128,102,1)" },
  { x: 50, y: 450, w: 250, h: 30, spriteId: 18, color: "rgba(102,128,102,1)" },
  { x: 50, y: 600, w: 150, h: 30, spriteId: 19, color: "rgba(102,128,102,1)" },
  { x: 250, y: 150, w: 200, h: 30, spriteId: 17, color: "rgba(102,128,102,1)" },
  { x: 550, y: 300, w: 200, h: 30, spriteId: 18, color: "rgba(102,128,102,1)" },
  { x: 800, y: 450, w: 250, h: 30, spriteId: 19, color: "rgba(102,128,102,1)" },
  { x: 500, y: 600, w: 150, h: 30, spriteId: 16, color: "rgba(102,128,102,1)" },
  { x: 1200, y: 200, w: 300, h: 30, spriteId: 14, color: "rgba(102,128,102,1)" },
  { x: 1300, y: 550, w: 100, h: 30, spriteId: 14, color: "rgba(102,128,102,1)" },
  { x: 1800, y: 350, w: 200, h: 30, spriteId: 14, color: "rgba(128,153,128,1)" },
  { x: 2100, y: 500, w: 150, h: 30, spriteId: 14, color: "rgba(128,153,128,1)" },
  { x: 2400, y: 250, w: 250, h: 30, spriteId: 14, color: "rgba(128,153,128,1)" },
  { x: 2800, y: 400, w: 200, h: 30, spriteId: 14, color: "rgba(128,153,128,1)" },
  { x: 3100, y: 600, w: 100, h: 30, spriteId: 14, color: "rgba(128,153,128,1)" },
  { x: 3400, y: 700, w: 300, h: 30, spriteId: 14, color: "rgba(128,153,128,1)" },
  { x: 3800, y: 500, w: 200, h: 30, spriteId: 14, color: "rgba(230,230,51,1)", isEnd: true },
  { x: 1600, y: 100, w: 150, h: 30, spriteId: 14, color: "rgba(51,153,204,1)", isMoving: true, minX: 1600, maxX: 2000, speed: 2.0 },
  { x: 2600, y: 600, w: 100, h: 30, spriteId: 14, color: "rgba(51,153,204,1)", isMoving: true, minX: 2600, maxX: 3000, speed: 1.5 },
  { x: 2200, y: 100, w: 100, h: 30, spriteId: 14, color: "rgba(204,51,51,1)", isSpike: true },
  { x: 3000, y: 150, w: 150, h: 30, spriteId: 14, color: "rgba(204,51,51,1)", isSpike: true }
];
